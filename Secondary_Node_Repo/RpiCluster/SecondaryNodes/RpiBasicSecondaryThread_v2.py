...
class RpiBasicSecondaryThread(threading.Thread):
    ...
    def bindSecondary(self):
        ...
        self.my_listening_socket.listen(len(self.NbrInfo))
    ...
    def epsilonconsUpdate(self, initialVal, consTol):  
        ...
        while True: 
            ...
            if (self.stopFlag == 1):
                logger.info("self.stopFlag = " +str(self.stopFlag))
                ...
                if (np.mod(iteration, self.Diam) == 0):  
                    ...
                    if (diff < consTol):
                        ...
                        #     logger.info("my converged value = " + str(self.myRatio))
                        #     self.result_to_primary(self.myRatio)
                        #     self.flag_to_primary(flag)
                        #     time.sleep(0.1)
                        #     break;
    ...
    def receive_stopFlag_from_Primary(self):
        message = self.connection_handler.get_message()
        if message['type'] == 'stop_flag':
            self.stopFlag = 1   
